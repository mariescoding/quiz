...
class QuizViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        quizArray.append(["シンガポールで一番使われている言語は？", "英語", "日本語", "中国語", 3])
        quizArray.append(["私の一番好きな食べ物は？", "カレー", "おにぎり", "バナナ", 2])
        quizArray.append(["クリスマスは何日？", "12/20", "12/24", "12/25", 3])
        quizArray.append(["私の好きな映画は？", "ミニオン", "ララランド", "ローグ・ワン", 3])
